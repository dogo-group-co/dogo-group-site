    ...
    return (
        <>
            <Head title="Dogo Group — Un idioma, carta a carta">
                ...
                <link
                    href="https://fonts.googleapis.com/css2?family=Anta&family=Jua&family=Lato:wght@400;700&family=Noto+Serif+SC:wght@500;600;700&family=ZCOOL+KuaiLe&display=swap"
                    rel="stylesheet"
                />
            </Head>
