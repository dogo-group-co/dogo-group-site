                ...
                <main className="mx-auto flex w-full max-w-[1060px] flex-1 flex-col items-center gap-14 px-6 pt-10 pb-20 text-center sm:px-10 sm:pt-16">
                    <section className="flex flex-col items-center gap-6">
                        ...
                        <div className="mt-2 flex flex-wrap items-center justify-center gap-3">
                            <a
                                href="https://wa.me/59898100448?text=%C2%A1Hola!%20Quiero%20pedir%20el%20mazo%20de%20Animales%20de%20Dogo%20Group."
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-3 rounded-full bg-seal px-7 py-3.5 text-base text-white no-underline transition-colors hover:bg-seal-dark hover:text-white hover:no-underline"
                            >
                            ...
                            <a
                                href="https://wa.me/59898100448?text=%C2%A1Hola!%20Quiero%20un%20mazo%20de%20cartas%20personalizado%20de%20Dogo%20Group."
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-3 rounded-full border border-ink px-7 py-3.5 text-base text-ink no-underline transition-colors hover:bg-ink hover:text-white hover:no-underline"
                            >
                    ...
                    <section className="flex w-full max-w-md flex-col items-center gap-4 rounded-[20px] border border-line bg-white p-8">
                        <span className="text-[13px] tracking-[0.16em] uppercase text-stone">El primer mazo</span>
                        <h2 className="text-2xl font-normal uppercase">Mazo Animales</h2>
                        <p className="text-[15px] text-mist">20 cartas · español, chino y pinyin</p>
                        <p className="text-4xl">$ 450</p>
                        <a
                            href="https://wa.me/59898100448?text=%C2%A1Hola!%20Quiero%20pedir%20el%20mazo%20de%20Animales%20de%20Dogo%20Group."
                            target="_blank"
                            rel="noopener noreferrer"
                            className="mt-1 flex items-center gap-2.5 rounded-full bg-seal px-6 py-3 text-sm text-white no-underline transition-colors hover:bg-seal-dark hover:text-white hover:no-underline"
                        >
